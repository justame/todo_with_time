...
class TodoItemsControllerTest < ActionController::TestCase
  ...
  test "should create todo_item" do
    assert_difference('TodoItem.count') do
      post :create, todo_item: { estimate_time: @todo_item.estimate_time, time: @todo_item.time, title: @todo_item.title }
    end
  ...
  test "should update todo_item" do
    put :update, id: @todo_item, todo_item: { estimate_time: @todo_item.estimate_time, time: @todo_item.time, title: @todo_item.title }
    assert_redirected_to todo_item_path(assigns(:todo_item))
  end
